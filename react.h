...
public:
    ...
    template <class T>
    str_or_num(T *_t) : ptr(static_cast<const void *>(_t)), kind(POINTER) {}
...
template <class T>
void print_char(T t) { error_for_print_("char"); }
template <class T>
void print_short(T t) { error_for_print_("short"); }
template <class T>
void print_int(T t) { error_for_print_("int"); }
template <class T>
void print_unsigned_int(T t) { error_for_print_("unsigned_int"); }
template <class T>
void print_long(T t) { error_for_print_("long"); }
template <class T>
void print_size_t(T t) { error_for_print_("size_t"); }
template <class T>
void print_long_long(T t) { error_for_print_("long_long"); }
template <class T>
void print_float(T t) { error_for_print_("float"); }
template <class T>
void print_double(T t) { error_for_print_("double"); }
